...
export function Topbar() {
  return (
    <header className="sticky top-0 z-40 bg-background/80 backdrop-blur border-b border-card-border">
      <div className="h-14 flex items-center gap-3 px-3" dir="rtl">
        ...
        <div className="flex items-center gap-3">
          <button aria-label="בחירת חברה" className="px-3 py-1.5 rounded-md bg-card-bg border border-card-border text-sm">חברה לדוגמה</button>
        </div>
        ...
        <div className="flex-1 max-w-[720px] mx-auto">
          ...
          <div className="relative">
            ...
            <input id="global-search" placeholder="חיפוש גלובלי…" className="w-full pr-9 pl-3 h-9 rounded-md border bg-card-bg border-card-border text-sm" dir="rtl" />
          </div>
        </div>
